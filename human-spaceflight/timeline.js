$(document).ready(function(){
	...
	function parseIt(data){
		...
		nmax++;
		for(var a = 0 ; a < astronauts.length; a++) html += '<div class="human '+astronauts[a].category+'" id="'+a+'" style="'+(astronauts[a].land ? '':'border-radius:1em 0 0 1em;')+'top:'+((astronauts[a].n/nmax)*96).toFixed(2)+'%;width:'+(astronauts[a].width).toFixed(0)+'px;margin-left:'+(astronauts[a].left).toFixed(3)+'%;height:'+(80/nmax).toFixed(2)+'%;" title="'+astronauts[a].name+'"><\/div>';
